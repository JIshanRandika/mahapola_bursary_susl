...
{{--                            @if(checkPermission(['admin']))--}}
                                ...
                                @foreach($mahapola_status as $s)
                                    ...
                                    @if(checkPermission(['admin']) && $s->faculty=='Graduate Studies')
                                ...
                                @if($s->level!=='0' && $s->faculty=='Graduate Studies')
                                    ...
                                    <div class="card text-center m-5">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @if($s->level!=='1' && $s->faculty=='Graduate Studies')
                                                <h6 class="card-text">Comments by Assistant Registrar:</h6>
                                                @foreach($mahapola_ar_comment as $arc)
                                                    @if($s->id==$arc->status_id)
                                                        <p>{{$arc->mahapola_ar_comment}}</p>
                                            ...
                                            @if($s->level=='3' && $s->faculty=='Graduate Studies')
                                                <form action="{{ route('mahapola_statuses.update',$s->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                            ...
                                            @if($s->level=='4' && $s->faculty=='Graduate Studies' )
                                                <form action="{{ route('mahapola_statuses.update',$s->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
