...
class TechMahapolaController extends Controller
{
    //
...
//        return view('home',compact('arcomment'));
        ...
        return view('tech_mahapola',compact('bursary_status','bursary_ar_comment','bursary_vc_or_reg_comment','mahapola_ar_comment','mahapola_status'));
    }
