...
class ManBursaryController extends Controller
{
    //
    //
...
//        return view('home',compact('arcomment'));
        ...
        return view('man_bursary',compact('bursary_status','bursary_ar_comment','bursary_vc_or_reg_comment','mahapola_ar_comment','mahapola_status'));
    }
